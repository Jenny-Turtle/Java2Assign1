  ...
  public MovieAnalyzer(String dataset_path) throws IOException {
    ...
    public Map<Integer, Integer> getMovieCountByYear(){
        Map<Integer, Long> years = movies.stream()
                .distinct()
                .collect(Collectors.groupingBy(movie -> movie.Released_Year,Collectors.counting()));
        ...
        if (by.equals("rating")){
            ...
            result = Stars.stream()
                    .sorted(new Comparator<Star>() {
                        @Override
                        public int compare(Star o1, Star o2) {
                            if (o2.averageGross > o1.averageGross) return 1;
                            else if (o2.averageGross < o1.averageGross) return -1;
                            else return o1.name.compareTo(o2.name) ;
                        }
                    })
                    .limit(top_k)
    ...
    public static void main(String[] args) throws IOException {
        MovieAnalyzer a = new MovieAnalyzer("C:\\Java2\\Assignment1\\resources\\imdb_top_500.csv");
        List<String> b = new ArrayList<>();
        b.add("Debbie Reynolds");
        b.add("Gene Kelly");

        System.out.println(a.getCoStarCount().get(b));
